...
class Historymtk_tiga extends CI_Controller{
	...
	function index(){		
		// List Siswa 
		$historymtk = $this->m_history->historymtk_tiga();
		$this->load->vars('him', $historymtk);

		// View Administrator
		$this->load->view("admin/header");
		$this->load->view("admin/menu");
		$this->load->view("admin/history/historymtk_tiga");
		$this->load->view("admin/footer");
	}

	// Start Hapus
	function hapus_historymtk_tiga($jam){
		$this->m_history->hapus_historymtk_tiga($jam);
		redirect('historymtk_tiga');
	}
	// End Hapus
