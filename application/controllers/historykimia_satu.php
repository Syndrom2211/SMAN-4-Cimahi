...
class Historykimia_satu extends CI_Controller{
	...
	function index(){		
		...
		$this->load->view("admin/history/historykimia_satu");
		$this->load->view("admin/footer");
	}

	// Start Hapus
	function hapus_historykimia_satu($jam){
		$this->m_history->hapus_historykimia_satu($jam);
		redirect('historykimia_satu');
	}
	// End Hapus
