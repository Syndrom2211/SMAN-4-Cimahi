...
class Historyinggris_satu extends CI_Controller{
	...
	function index(){		
		...
		$this->load->view("admin/history/historyinggris_satu");
		$this->load->view("admin/footer");
	}

	// Start Hapus
	function hapus_historyinggris_satu($jam){
		$this->m_history->hapus_historyinggris_satu($jam);
		redirect('historyinggris_satu');
	}
	// End Hapus
