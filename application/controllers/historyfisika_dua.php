...
class Historyfisika_dua extends CI_Controller{
	...
	function index(){		
		// List Siswa 
		$historyfisika = $this->m_history->historyfisika_dua();
		$this->load->vars('hia', $historyfisika);

		// View Administrator
		$this->load->view("admin/header");
		$this->load->view("admin/menu");
		$this->load->view("admin/history/historyfisika_dua");
		$this->load->view("admin/footer");
	}

	// Start Hapus
	function hapus_historyfisika_dua($jam){
		$this->m_history->hapus_historyfisika_dua($jam);
		redirect('historyfisika_dua');
	}
	// End Hapus
