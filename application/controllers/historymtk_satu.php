...
class Historymtk_satu extends CI_Controller{
	...
	function index(){		
		// List Siswa 
		$historymtk = $this->m_history->historymtk_satu();
		$this->load->vars('him', $historymtk);

		// View Administrator
		$this->load->view("admin/header");
		$this->load->view("admin/menu");
		$this->load->view("admin/history/historymtk_satu");
		$this->load->view("admin/footer");
	}

	// Start Hapus
	function hapus_historymtk_satu($jam){
		$this->m_history->hapus_historymtk_satu($jam);
		redirect('historymtk_satu');
	}
	// End Hapus
