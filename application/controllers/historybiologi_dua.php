...
class Historybiologi_dua extends CI_Controller{
	...
	function index(){		
		// List Siswa 
		$historybiologi = $this->m_history->historybiologi_dua();
		$this->load->vars('hia', $historybiologi);

		// View Administrator
		$this->load->view("admin/header");
		$this->load->view("admin/menu");
		$this->load->view("admin/history/historybiologi_dua");
		$this->load->view("admin/footer");
	}

	// Start Hapus
	function hapus_historybiologi_dua($jam){
		$this->m_history->hapus_historybiologi_dua($jam);
		redirect('historybiologi_dua');
	}
	// End Hapus
