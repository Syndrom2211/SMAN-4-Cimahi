...
class Historyekonomi_dua extends CI_Controller{
	...
	function index(){		
		// List Siswa 
		$historyekonomi = $this->m_history->historyekonomi_dua();
		$this->load->vars('hia', $historyekonomi);

		// View Administrator
		$this->load->view("admin/header");
		$this->load->view("admin/menu");
		$this->load->view("admin/history/historyekonomi_dua");
		$this->load->view("admin/footer");
	}

	// Start Hapus
	function hapus_historyekonomi_dua($jam){
		$this->m_history->hapus_historyekonomi_dua($jam);
		redirect('historyekonomi_dua');
	}
	// End Hapus
