...
class Historyinggris_dua extends CI_Controller{
	...
	function index(){		
		// List Siswa 
		$historyinggris = $this->m_history->historyinggris_dua();
		$this->load->vars('hin', $historyinggris);

		// View Administrator
		$this->load->view("admin/header");
		$this->load->view("admin/menu");
		$this->load->view("admin/history/historyinggris_dua");
		$this->load->view("admin/footer");
	}

	// Start Hapus
	function hapus_historyinggris_dua($jam){
		$this->m_history->hapus_historyinggris_dua($jam);
		redirect('historyinggris_dua');
	}
	// End Hapus
