...
class Historysosiologi_satu extends CI_Controller{
	...
	function index(){		
		...
		$this->load->view("admin/history/historysosiologi_satu");
		$this->load->view("admin/footer");
	}

	// Start Hapus
	function hapus_historysosiologi_satu($jam){
		$this->m_history->hapus_historysosiologi_satu($jam);
		redirect('historysosiologi_satu');
	}
	// End Hapus
