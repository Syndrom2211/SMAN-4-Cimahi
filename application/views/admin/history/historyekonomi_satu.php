                                                ...
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a onclick="return confirm('Yakin mau hapus ?');" href="<?php echo base_url().'historyekonomi_satu/hapus_historyekonomi_satu/'.$historyekonomi->jam; ?>"><i class="fa fa-trash-o"></i></a></td>
                                                        </tr>
                                                        <?php
                                                    	}
                                                        ?>
