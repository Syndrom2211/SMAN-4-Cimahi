                                                ...
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a onclick="return confirm('Yakin mau hapus ?');" href="<?php echo base_url().'historysejarah_dua/hapus_historysejarah_dua/'.$historysejarah->jam; ?>"><i class="fa fa-trash-o"></i></a></td>
                                                        </tr>
                                                        <?php
                                                    	}
                                                        ?>
