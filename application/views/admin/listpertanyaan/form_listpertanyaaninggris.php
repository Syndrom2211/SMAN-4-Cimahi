                        ...
                        <!-- Horizontal form -->
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Edit List Pertanyaan B.Inggris</h3></div>
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" role="form" action="<?php echo base_url('listpertanyaaninggris/prosesedit_listpertanyaaninggris'); ?>" method="POST" enctype="multipart/form-data">  
                                        <input type="hidden" name="id_pertanyaan" value="<?php echo $lpin->row('id_pertanyaan'); ?>">  
                                            ...
                                            <div class="form-group m-b-0">
                                                <div class="col-sm-offset-3 col-sm-9">
                                                  ...
                                                  <a href="<?php echo base_url('listpertanyaaninggris'); ?>"><button type="button" class="btn btn-default waves-effect m-b-5">Kembali</button></a>
                                                </div>
                                            </div>
                                        </form>
                                    </div> <!-- panel-body -->
