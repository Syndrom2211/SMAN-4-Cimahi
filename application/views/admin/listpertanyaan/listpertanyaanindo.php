                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">List Pertanyaan B.Indonesia</h3>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" role="form" action="<?php echo base_url('listpertanyaanindo/prosestambah_listpertanyaanindo'); ?>" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatabletanya" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                    	<?php
                                                    	$i = 1;
                                                    	foreach($lpin as $listpertanyaanindo){
                                                    	?>
                                                        <tr>
                                                            <td><?php echo $i; ?></td>
                                                            <td><?php echo $listpertanyaanindo->pertanyaan; ?></td>
                                                            <td><?php echo $listpertanyaanindo->ganda_a; ?></td>
                                                            <td><?php echo $listpertanyaanindo->ganda_b; ?></td>
                                                            <td><?php echo $listpertanyaanindo->ganda_c; ?></td>
                                                            <td><?php echo $listpertanyaanindo->ganda_d; ?></td>
                                                            <td><?php echo $listpertanyaanindo->ganda_e; ?></td>
                                                            <td><?php echo $listpertanyaanindo->jawaban; ?></td>
                                                            <td class="actions">
                                                                <a href="<?php echo base_url().'listpertanyaanindo/edit_listpertanyaanindo/'.$listpertanyaanindo->id_pertanyaan; ?>"><i class="fa fa-pencil"></i></a>
                                                                <a onclick="return confirm('Yakin mau hapus ?');" href="<?php echo base_url().'listpertanyaanindo/hapus_listpertanyaanindo/'.$listpertanyaanindo->id_pertanyaan; ?>"><i class="fa fa-trash-o"></i></a>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                        $i++;
