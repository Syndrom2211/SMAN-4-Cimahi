                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">List Pertanyaan Ekonomi</h3>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" role="form" action="<?php echo base_url('listpertanyaanekonomi/prosestambah_listpertanyaanekonomi'); ?>" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatabletanya" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                    	<?php
                                                    	$i = 1;
                                                    	foreach($lpi as $listpertanyaanekonomi){
                                                    	?>
                                                        <tr>
                                                            <td><?php echo $i; ?></td>
                                                            <td><?php echo $listpertanyaanekonomi->pertanyaan; ?></td>
                                                            <td><?php echo $listpertanyaanekonomi->ganda_a; ?></td>
                                                            <td><?php echo $listpertanyaanekonomi->ganda_b; ?></td>
                                                            <td><?php echo $listpertanyaanekonomi->ganda_c; ?></td>
                                                            <td><?php echo $listpertanyaanekonomi->ganda_d; ?></td>
                                                            <td><?php echo $listpertanyaanekonomi->ganda_e; ?></td>
                                                            <td><?php echo $listpertanyaanekonomi->jawaban; ?></td>
                                                            <td class="actions">
                                                                <a href="<?php echo base_url().'listpertanyaanekonomi/edit_listpertanyaanekonomi/'.$listpertanyaanekonomi->id_pertanyaan; ?>"><i class="fa fa-pencil"></i></a>
                                                                <a onclick="return confirm('Yakin mau hapus ?');" href="<?php echo base_url().'listpertanyaanekonomi/hapus_listpertanyaanekonomi/'.$listpertanyaanekonomi->id_pertanyaan; ?>"><i class="fa fa-trash-o"></i></a>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                        $i++;
