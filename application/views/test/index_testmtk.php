            ...
            <div class="row no-gutter fullwidth"><!-- row -->
                ...
                <div class="col-lg-12 col-md-12"><!-- doc body wrapper -->
                    ...
                    <div class="col-padded" style="box-shadow: 0 0 15px 1px #c6c6c6;"><!-- inner custom column -->
                        ...
                        <h1 class="page-title"><br>Test Online Matematika</h1>
                        ...
                        <div class="news-body">
                            ...
                            ?>
								...
								echo form_open('page/testmtk_mulai/'.$pertanyaan_selanjutnya, $atribut); ?>
	                                    <?php
							...
							?>
									<div class="bullet-paragraph-wrap"><!-- bullet paragraph -->
                                        ...
                                        <div class="bullet-paragraph-text">
                                            ...
                                            ?>
                                            <form class="form-horizontal" role="form" action="<?php echo base_url('page/sessionbaru_mtk1'); ?>" method="POST" enctype="multipart/form-data">  
                                            <?php
                                        	}else{
                                        	?>
                                            <form class="form-horizontal" role="form" action="<?php echo base_url('page/sessionbaru_mtk2'); ?>" method="POST" enctype="multipart/form-data">  
                                            <?php
                                        	}
                                        	?>
